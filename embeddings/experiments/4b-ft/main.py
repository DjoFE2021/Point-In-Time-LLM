...
CKPT_DIR          = "/scratch/jschwab/checkpoints/4B-FT"
CKPT_DIR_FULL     = "/scratch/jschwab/checkpoints/4B-FT-full"
OUTPUT_DIR        = "/scratch/jschwab/embeddings/4b-ft-v2"
OUTPUT_DIR_FULL   = "/scratch/jschwab/embeddings/4b-ft-full-v2"
MAX_TOKENS        = 2048
BATCH_SIZE        = 64
